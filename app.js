          ...
          <div class="detail-actions">
            ...
            <div class="detail-actions-row">
              ...
              <button class="btn-telegram" onclick="window.open('https://t.me/MixModaFeminina', '_blank')">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.3l15.9-6.12c.73-.33 1.43.18 1.15 1.3l-2.7 12.76c-.2.86-.7 1.07-1.42.67l-3.92-2.89-1.89 1.82c-.2.2-.37.37-.73.37z"/></svg>
                Telegram
              </button>
            </div>
          </div>
