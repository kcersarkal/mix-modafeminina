...
('shopee', 'shp-005', 'Short Jeans Feminino Cintura Alta', 'Shorts', 59.90, 69.90, 'https://images.unsplash.com/photo-1593032454539-3c103e6e3a8c?q=80&w=800&auto=format&fit=crop', 'Short jeans cintura alta, modelagem confortável e moderna. Ideal para looks casuais.', 4.4, 267, '-15%', false, '#'),
('shopee', 'shp-006', 'Saia Midi Jeans Feminina', 'Saias', 69.90, NULL, 'https://images.unsplash.com/photo-1583499871880-9ac2cd7fc6d9?q=80&w=800&auto=format&fit=crop', 'Saia midi jeans feminina, modelagem reta e confortável. Perfeita para looks casuais e elegantes.', 4.3, 189, 'Novo', false, '#');
